...
const steps = [
  {
    ...
    desc: "Hosts upload photos and basic details so guests can quickly understand the space, its features, and what makes it unique.",
    glow: "/images/star1.png", 
  },
  {
    id: 2,
    title: "Safety & Comfort Review",
    desc: "Our team reviews fire safety, carbon monoxide risks, exits, lighting, hazards, and  comfort to ensure every space meets essential safety.",
    glow: "/images/star2.png",
  },
  {
    id: 3,
    title: "Get Verified",
    desc: "Hosts get the Trusted Stay Badge, Safety Report, and unique QR code to highlight verified safety and build guest confidence.",
...
function CardSection() {
  return (
    <div className="container-class px-[120px] bg-[#121315] max-w-[1440px] mx-auto py-[80px] max-[1100px]:px-[80px] max-[1100px]:py-[60px] max-[430px]:px-[19px] max-[430px]:py-8">
      {/* Top Section */}
      <div className="flex flex-col gap-[24px]">
        ...
        <p className="text-[#FFFFFF99] font-medium text-[18px] leading-[22px] max-[425px]:text-[14px] w-full max-w-[673px]">
          Effortlessly list, manage, and book your properties through our
          streamlined and transparent process, designed to make hosting smoother
          than ever.
        </p>
      </div>
    ...
    `,
              ...
              <span className="text-[#121315] font-semibold text-[20px] leading-[24px] ">
                {step.title}
              </span>
            </div>
