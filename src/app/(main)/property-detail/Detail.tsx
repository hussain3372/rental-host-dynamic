  ...
  return (
    <div className="pt-[168px] max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
      ...
      <div className="flex gap-[12px] items-center pb-[40px] flex-wrap">
        <p className="font-regular text-[12px] sm:text-[16px] leading-[20px] text-center text-white opacity-60">
          Home
        </p>
        <Image
        ...
        <Image
          ...
          className="w-[16px] h-[16px]"
        />
        <p className="font-regular text-[12px] sm:text-[16px] leading-[20px] text-center text-white">
        ...
        <div className="relative w-full h-[300px] sm:h-[400px] lg:h-[500px] rounded-lg overflow-hidden bg-gray-800">
          <Image
            ...
            onError={(e) => {
              ...
              target.src = `https://via.placeholder.com/800x500/2d2d2d/EFFC76?text=Property+Image+${
                currentStep + 1
              }`;
            }}
          />
      ...
      <p className="font-medium text-[16px] leading-[25px] sm:text-[24px] sm:leading-[32px] text-white opacity-80">
        {" "}
        The Grand Oak Residence at 1234 Maplewood Avenue, Austin, Texas is a
        fully verified and certified property. Featuring 4 bedrooms, 3
        bathrooms, and a modern kitchen, this home combines comfort with trust.
        With a landscaped garden, private patio, and verified legal
        documentation, it offers both luxury and peace of mind. Each listing
        comes with a digital badge and QR code for instant authenticity checks.
      </p>
    </div>
  );
}
