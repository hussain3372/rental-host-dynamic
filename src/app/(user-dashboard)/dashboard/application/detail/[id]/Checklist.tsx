...
export default function Checklist({ application }: ChecklistProps) {
  ...
  useEffect(() => {
    ...
    if (
      application.complianceChecklist &&
      typeof application.complianceChecklist === "object"
    ) {
      const checklistArray: ChecklistItem[] = Object.entries(
        application.complianceChecklist
      ...
      console.warn(
        "❌ Checklist - No complianceChecklist found in application"
      );
      setChecklistItems([]);
    }
  }, [application]);
        ...
        <div className="flex flex-col justify-between flex-1">
          {documents.length > 0 ? (
            documents.map((doc) => (
              ...
              >
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    <h3 className="font-medium text-[12px] sm:text-[16px] leading-4 sm:leading-5 text-white max-w-[250px] truncate">
            ...
            <div className="bg-[#121315] p-6 rounded-lg text-center">
              <p className="text-white/60 font-medium text-[16px] leading-5">
