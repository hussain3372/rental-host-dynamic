...
export function Navbar({ isCollapsed }: NavbarProps) {
  ...
  // ✅ Format date and greeting (unchanged functionality)
  useEffect(() => {
    const date = new Date();
        ...
        >
          <div className="flex justify-between items-center border-b border-b-[#3b3d3c]">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-medium text-[14px] leading-[18px]">Loading...</p>
          ...
          <div className="flex justify-between items-center px-4 py-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-[12px] font-normal text-white/60">Loading...</p>
              </div>
            </div>
          </div>
        </nav>
  ...
  return (
    <>
      ...
      >
        <div className="flex justify-between items-center border-b border-b-[#3b3d3c]">
          {/* Left side - Unchanged functionality */}
          <div className={`${isCollapsed ? "ml-[10px]" : "ml-0"}`}>
          ...
          {/* Right side - Profile with API data */}
          <Link
