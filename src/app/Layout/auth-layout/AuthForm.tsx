...
const AuthForm: React.FC<AuthFormProps> = ({
  ...
  const validateForm = (): boolean => {
    ...
    } else if (mode === "signup" && formData.password.trim().length < 8) {
      newErrors.password = "Password must be at least 8 characters long.";
    } else if (mode === "signup" && formData.password.trim().length > 20) {
        ...
        return (
          <>
            ...
            <div className="flex justify-end w-[103%] 2xl:w-full">
              <Link href={forgotlink || "/auth/forgot-password"}>
  ...
  return (
    <div className="min-h-screen bg-[#121315] xl:gap-[80px] flex flex-col xl:flex-row">
      {/* Left Panel */}
      <div className="flex items-center justify-center px-[20px] md:px-[80px] py-8 w-full xl:w-1/2">
