...
//             underReview: response.data.applications.underReview || 0,
//             approved: response.data.applications.approved || 0,
//             rejected: response.data.applications.rejected || 0,
//             moreInfoRequested: response.data.applications.moreInfoRequested || 0
//           },
//           certifications: {
//             active: response.data.certifications.active || 0,
//             expired: response.data.certifications.expired || 0,
//             revoked: response.data.certifications.revoked || 0,
//             expiring: response.data.certifications.expiringSoon || 0,
//             total: response.data.certifications.total || 0
//           },
//           recentActivity: {
...
//   const generateApplicationStats = (range: "weekly" | "monthly" | "yearly") => {
...
//                 centerText={{ 
//                   label: "Total", 
//                   value: data.certifications.total.toLocaleString() 
//                 }}
//               />
//             </div>
//           </div>
