        ...
        >
          ...
          <div className="p-6 sticky bottom-0 bg-[#0A0C0B] ">
            <button
              ...
              className="w-full yellow-btn cursor-pointer text-black font-semibold py-4 rounded-md transition-all duration-200 ease-out hover:scale-[1.02] active:scale-[0.98] text-sm shadow-[inset_0_4px_6px_rgba(0,0,0,0.3)] hover:shadow-[inset_0_6px_8px_rgba(0,0,0,0.4)]"
            >
              {buttonLabel}
            </button>
          </div>
