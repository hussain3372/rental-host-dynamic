        ...
        setStatsData([
          {
            ...
            title: "Total Applications",
            number:
              response.data.dashboard.applications.total?.toString() || "0",
            status: "+8%",
            color: "#28EB1D",
            braces: "(growth compared to last month)",
            img: "/images/card1.svg",
          },
          {
            ...
            title: "Active Applications",
            number:
              response.data.dashboard.applications.approved?.toString() || "0",
            status: "+4%",
            color: "#28EB1D",
            braces: "increase in certifications last month",
            img: "/images/card2.svg",
          },
          {
            ...
            title: "Pending Applications",
            number:
              response.data.dashboard.applications.pending?.toString() || "0",
            status: "+4%",
            color: "#FF3F3F",
            braces: "expired certifications last month",
            img: "/images/reject.svg",
