  ...
  import { RefundRequest,Transaction } from "@/app/api/super-admin/setting/types";
  ...
  const RefundDrawer = ({ isOpen, onClose, transaction, onRefundSuccess }: RefundDrawerProps) => {
